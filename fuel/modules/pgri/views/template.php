...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $this->asset->assets_path('template/plugins/goodlayers-core/plugins/combine/style.css') ?>"  type='text/css' media='all'>
    <link rel="stylesheet" href="<?php echo $this->asset->assets_path('template/plugins/goodlayers-core/include/css/page-builder.css') ?>" type='text/css' media='all'>
    <link rel="stylesheet" href="<?php echo $this->asset->assets_path('template/plugins/revslider/public/assets/css/settings.css') ?>"  type='text/css' media='all'>
    <link rel="stylesheet" href="<?php echo $this->asset->assets_path('template/plugins/revslider/public/assets/css/settings.css') ?>"  type='text/css' media='all'>

    <link href="<?php echo $this->asset->assets_path('template/css/style-core.css') ?>" rel="stylesheet" type='text/css' media='all'>
    <link href="<?php echo $this->asset->assets_path('template/css/kingster-style-custom.css') ?>" rel="stylesheet" type='text/css' media='all'>
...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
            ...
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo  kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="<?php echo base_url()?>"><img src="<?php echo $this->asset->assets_path('template/images/logo.png') ?>" alt="" /></a>
                    </div>
                </div>
                            ...
                            <ul id="menu-main-navigation" class="m-menu">
                                <li class="menu-item menu-item-home current-menu-item menu-item-has-children"><a href="#">Home</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item menu-item-home"><a href="<?php echo base_url()?>" style="color: red">Homepage 1</a></li>
                                        <li class="menu-item"><a href="<?php echo base_url()?>"style="color: red">Homepage 2</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children"><a href="#">Pages</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/about')?>"style="color: red">About KU</a></li>
                                        <li class="menu-item menu-item-has-children"><a href="#">Blog</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children"><a href="#">Blog Full</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="<?php echo site_url('pgri/article_list')?>"style="color: red">Articles</a></li>
                                                ...
                                                <li class="menu-item menu-item-has-children"><a href="#">Blog Grid</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="<?php echo site_url('pgri/article_list')?>"style="color: red">Articles</a></li>
                                        ...
                                        <li class="menu-item menu-item-has-children"><a href="#">Contact</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item"><a href="<?php echo site_url('pgri/contact')?>"style="color: red">Contact</a></li>
                                        ...
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/gallery')?>"style="color: red"style="color: red">Gallery</a></li>
                                ...
                                <li class="menu-item menu-item-has-children"><a href="#">Academics</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item menu-item-has-children"><a>Undergraduate</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item"><a href="<?php echo site_url('pgri/overview_1')?>"style="color: red">Departement Overview 1</a></li>
                                                <li class="menu-item"><a href="<?php echo site_url('pgri/overview_2')?>"style="color: red">Departement Overview 2</a></li>
                                                <li class="menu-item"><a href="<?php echo site_url('pgri/instructor')?>"style="color: red">Departement Instructor</a></li>
                                                <li class="menu-item"><a href="<?php echo site_url('pgri/instructor_detail')?>"style="color: red">Instructor Profile</a></li>
                                ...
                                <li class="menu-item menu-item-has-children"><a href="#">Admissions</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/admission')?>"style="color: red">Admission</a></li>
                                        ...
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/scholarship')?>"style="color: red">Scholarships</a></li>
                                        ...
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/alumni') ?>"style="color: red">Alumni</a></li>
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/event') ?>"style="color: red">Event Calendar</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children"><a href="#">Courses</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="<?php echo site_url('pgri/download')?>"style="color: red">Download</a></li>
                                ...
                                <li class="menu-item"><a href="athletics.html">Athletics</a></li>
                                <li class="menu-item"><a href="<?php echo site_url('pgri/life')?>"style="color: red">University Life</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kingster-top-bar-container-inner clearfix">
                        ...
                        <div class="kingster-top-bar-right kingster-item-pdlr">
                            <ul id="kingster-top-bar-menu" class="sf-menu kingster-top-bar-menu kingster-top-bar-right-menu">
                                <li class="menu-item kingster-normal-menu"><a href="<?php echo site_url('pgri/alumni')?>"style="color: red"style="color: red">Alumni</a></li>
                            ...
                            <div class="kingster-main-menu" id="kingster-main-menu">
                                <ul id="menu-main-navigation-1" class="sf-menu">
                                    <li class="menu-item menu-item-home current-menu-item menu-item-has-children kingster-normal-menu"><a href="index.html" class="sf-with-ul-pre">Home</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item menu-item-home" data-size="60"><a href="<?php echo base_url()?>"style="color: red">Homepage 1</a></li>
                                            <li class="menu-item" data-size="60"><a href="<?php echo base_url()?>"style="color: red">Homepage 2</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="#" class="sf-with-ul-pre">Pages</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item" data-size="60"><a href="<?php echo site_url('pgri/about')?>"style="color: red">About KU</a></li>
                                            ...
                                            <li class="menu-item" data-size="60"><a href="<?php echo site_url('pgri/gallery')?>"style="color: red">Gallery</a></li>
                                        ...
                                        <div class="sf-mega sf-mega-full megaimg">
                                            <ul class="sub-menu">
                                                ...
                                                <li class="menu-item" data-size="15">
                                                    <div class="kingster-mega-menu-section-content"><img src="<?php echo $this->asset->assets_path('template/upload/mega-menu-logo.png')?>" style="margin-bottom: 13px;" alt="" /> <span style="font-size: 14px; font-weight: 500;">Academic offerings include 95 majors, 86 minors, and more than 100 in-major specializations</span></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="menu-item menu-item-has-children kingster-normal-menu"><a href="apply-to-kingster.html" class="sf-with-ul-pre">Admissions</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item" data-size="60"><a href="<?php echo site_url('pgri/scholarship')?>"style="color: red">Scholarships</a></li>
                        ...
                        <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                            <div id="text-2" class="widget widget_text kingster-widget">
                                <div class="textwidget">
                                    <p><img src="<?php echo $this->asset->assets_path('template/upload/footer-logo.png')?>" alt="" />
					...
					<div class="kingster-copyright-container kingster-container clearfix">
						...
						<div class="kingster-copyright-right kingster-item-pdlr">
							<div class="gdlr-core-social-network-item gdlr-core-item-pdb  gdlr-core-none-align" style="padding-bottom: 0px ;">
								<a href="facebook.com" target="_blank" class="gdlr-core-social-network-icon" title="facebook">
									<i class="fa fa-facebook" ></i>
								</a>
								<a href="gogle.com" target="_blank" class="gdlr-core-social-network-icon" title="google-plus">
									<i class="fa fa-google-plus" ></i>
								</a>
								<a href="linkedin.com" target="_blank" class="gdlr-core-social-network-icon" title="linkedin">
									<i class="fa fa-linkedin" ></i>
								</a>
								<a href="skype.com" target="_blank" class="gdlr-core-social-network-icon" title="skype">
									<i class="fa fa-skype" ></i>
								</a>
								<a href="twitter.com" target="_blank" class="gdlr-core-social-network-icon" title="twitter">
									<i class="fa fa-twitter" ></i>
								</a>
								<a href="instagram.con" target="_blank" class="gdlr-core-social-network-icon" title="instagram">
    ...
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/js/jquery/jquery.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/js/jquery/jquery-migrate.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.slideanims.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.layeranimation.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.kenburn.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.navigation.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.parallax.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.actions.min.js") ?>'></script>
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/revslider/public/assets/js/extensions/revolution.extension.video.min.js") ?>'></script>
    ...
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/goodlayers-core/plugins/combine/script.js") ?>'></script>
    ...
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/plugins/goodlayers-core/include/js/page-builder.js") ?>'></script>
    


    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/js/jquery/ui/effect.min.js") ?>'></script>
    ...
    <script type='text/javascript' src='<?php echo $this->asset->assets_path("template/js/plugins.min.js") ?>'></script>
