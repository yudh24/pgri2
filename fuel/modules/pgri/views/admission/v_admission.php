<div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(<?php echo $this->asset->assets_path('template/upload/page-title-apply.jpg')?>) ;">
                ...
                <div class="gdlr-core-page-builder-body">
                    ...
                    <div class="gdlr-core-pbf-wrapper " style="padding: 660px 0px 30px 0px;">
                        <div class="gdlr-core-pbf-background-wrap">
                            <div class="gdlr-core-pbf-background" style="background-image: url(<?php echo $this->asset->assets_path('template/upload/shutterstock_299633474.jpg')?>) ;background-size: cover ;background-position: center ;background-attachment: fixed ;"></div>
                        </div>
                        <div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
